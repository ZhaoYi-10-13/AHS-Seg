...
def add_cat_seg_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.USE_ADAPTIVE_ENERGY = True
    cfg.MODEL.SEM_SEG_HEAD.ENERGY_LOSS_WEIGHT = 0.01
    
    # 创新点2: MH-FPN (多尺度超球面特征金字塔)
    cfg.MODEL.SEM_SEG_HEAD.USE_MULTI_SCALE_FUSION = True
    cfg.MODEL.SEM_SEG_HEAD.MS_LAYER_INDICES = [3, 7, 11]
    cfg.MODEL.SEM_SEG_HEAD.BOUNDARY_LOSS_WEIGHT = 0.1
    
    # 创新点3: DC-HSP (动态类别感知超球面投影)
